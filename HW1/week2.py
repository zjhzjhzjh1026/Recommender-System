...
print "Reading data..."
data2 = list(parseData("http://jmcauley.ucsd.edu/cse255/data/amazon/book_images_5000.json"))
print "done"

X = [b['image_feature'] for b in data2]
y = ["Children's Books" in b['categories'] for b in data2]
